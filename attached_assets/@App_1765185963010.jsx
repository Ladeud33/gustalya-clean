  ...
  return (
    <>
      <div style={{ 
        ...
        {/* Header avec logo Gustalya - Desktop uniquement */}
        {!isMobile && (
          <header style={{
            display: 'flex',
            flexDirection: 'column',
          ...
          <header style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <img src="/logo-gustalya.png" alt="Logo Gustalya" style={{ height: 32, width: 32, borderRadius: '50%', background: '#e6e6d6', border: '2px solid #a3b18a', objectFit: 'cover' }} />
                <span style={{ fontSize: 14, color: '#4E2E1E', fontWeight: 600 }}>Gustalya</span>
              </div>
        ...
        <main style={{ 
          ...
          {currentView === 'cooking' && <CookingAssistant />}
        ...
        {selectedRecipe && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ fontSize: isMobile ? '16px' : '18px', fontWeight: '600', color: '#4E2E1E', marginBottom: '12px' }}>
                  🛒 Ingrédients
                </h3>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <ol style={{ paddingLeft: isMobile ? '16px' : '20px', margin: 0 }}>
